...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        simulateButton.setOnClickListener {
            ...
            updateUI(noise, currentNoiseText, statusText, noiseProgressBar)
        }
        ...
        try {
            ...
            mqttClient.setCallback(object : MqttCallback {
                override fun messageArrived(topic: String?, message: MqttMessage?) {
                    ...
                    runOnUiThread {
                        when (topic) {
                            "audio/volume/pi_mic" -> updateUI(db.toInt(), currentNoiseText, statusText, noiseProgressBar)
    ...
    private fun updateUI(noise: Int, noiseText: TextView, status: TextView, bar: ProgressBar) {
